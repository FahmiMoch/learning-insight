...
export default function MainDashboard() {
  ...
  return (
    <main className="w-full min-h-screen bg-[#f2f2f2] text-[#333]">
      ...
      {/* Navbar tetap pakai Header tapi tambahkan notifikasi */}
      <Header />
      ...
      {/* Status Langganan tambahan dari semantic baru */}
        ...
        <article className="bg-white text-black w-full p-4 rounded-xl shadow-md border border-black/10">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between border border-black/10 border-b py-3 gap-4 md:gap-0">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm leading-none">Langganan telah berakhir. Berlangganan kembali untuk melanjutkan aktivitas belajar Anda.</p>
            </div>
            <button className="bg-[#033E5F] text-white px-4 py-2 rounded-lg hover:bg-blue-700">Lanjut Berlangganan</button>
          </div>
        </article>
      </section>
      ...
      <section className="max-w-screen-xl mx-auto px-4 lg:px-6 py-10 space-y-8">
        ...
        <article className="bg-white p-4 rounded-xl shadow-md">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <button className="bg-gray-100 p-4 rounded-lg shadow-sm hover:bg-gray-200 cursor-pointer text-left">Telusuri event dari Dicoding</button>
            <button className="bg-gray-100 p-4 rounded-lg shadow-sm hover:bg-gray-200 cursor-pointer text-left">Telusuri challenge dari Dicoding</button>
            <button className="bg-gray-100 p-4 rounded-lg shadow-sm hover:bg-gray-200 cursor-pointer md:col-span-2 text-left">Telusuri daftar pekerjaan perusahaan ternama</button>
          </div>
        </article>
      </section>
